...
<body>
    ...
    appCSS = `<style =type'text/css'>${appCSS}</style>`

    // let appJS = depsBundle || ''

    // appJS += '/* END DEPS BUNDLE */'
    let appJS = appBundle + '/* END APP BUNDLE */'
    ...
    let iframeHTML = appCSS + appHTML + appJS + '</body></html><!-- END iframeHTML-->'
