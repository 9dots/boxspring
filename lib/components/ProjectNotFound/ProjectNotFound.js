    ...
    return (
      ...
      >
        ...
        <Flex
          ...
          pt={40}
        >
          <h2 fontFamily='ornate' style={{textAlign: "center"}}>Error: Project '{props.projectId}' could not be found.</h2>
          <GameButton onClick={props.goToHomePage} ml="auto" mr="auto" bg='green' px='12px' py='7px' h="35px" fs="15px" color="black">
            <Icon fs='20px' bolder name='home' mr='6px'/>
