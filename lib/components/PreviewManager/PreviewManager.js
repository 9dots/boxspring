  ...
  * onCreate({state, props, actions}) {
  ...
  controller: {
    ...
    * buildAndRunApp({props, state, actions, context}, server) {
      ...
      let appBundle = yield props.getFileContentsFromName(`${context.projectId}/index.js`)
    	...
    	>
          ...
          <h2 style={{margin:"4px 0px 4px 0px", fontSize: "15px"}}>Preview</h2>
            <Flex align='flex-end center' h="35px">
              ...
              <GameButton disabled={buildInProgress} onClick={actions.buildAndRunApp} bg={buildInProgress ? "gray" : "#00aaf0" }  px='5px' py='3px' h="25px" fs="14px" color={buildInProgress ? "#ccc" : "black" }>
