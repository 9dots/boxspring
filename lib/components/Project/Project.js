...
export default fire((props) => ({
  ...
  component({
    ...
    * onUpdate (prev, {props, state, actions, context}) {
      let {project, fileTree, fileDescriptors} = props
      ...
      // if (state.ready)
      //   yield context.setProjectState({project: project.value, fileTree: fileTree.value, fileDescriptors: fileDescriptors.value})
    },
